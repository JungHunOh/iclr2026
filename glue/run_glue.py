...
class ModelArguments:
    ...
    cls_lr: Optional[float] = field(
        default=4e-3,
        metadata={"help": "LoRA classifier learning rate"},
    )
...
def main():
    ...
    if model_args.model_name_or_path == "google-t5/t5-base":
        ...
        classifier_group = [p for p in model.classification_head.parameters()]
        ...
        for p in model.classifier.parameters():
            p.requires_grad = True
        classifier_group = [p for p in model.classifier.parameters()]
    ...
    trainer = Trainer(
        ...
        prepare_ratio=model_args.prepare_ratio,
    )
